...
int main()
{
    ...
    cout<<endl;
    node*newLL=splitAltNodes(head1);

    cout<<"The linked list after splitting alternate nodes is: \n\n 1) First LL is:"<<head1<<"\n2) Second LL is:"<<newLL;
